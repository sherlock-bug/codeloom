...
> **测试二进制**：`/mnt/d/RagMcpHermes/codeloom/target/debug/codeloom`
> **测试仓库**：leveldb (C++) @ branch=master
> **调用方式**：`echo 'JSON-RPC-REQUEST' | ./codeloom mcp`
> **版本**：v1.0 — 2026-05-12 (Updated: 2026-05-14, leveldb 统一为唯一测试仓库)
...
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"codeloom_list_repos","arguments":{}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb 仓库已索引，分支包含 `__builtin__` 和 `master` |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"codeloom_list_branches","arguments":{"repo":"leveldb"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
| **预期结果** | `result.content[0].text` 包含 `"__builtin__"` 和 `"master"` |
...
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"codeloom_list_symbols","arguments":{"pattern":"compaction","repo":"leveldb","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":5,"method":"tools/call","params":{"name":"codeloom_list_symbols","arguments":{"pattern":"","repo":"leveldb","branch":"master","limit":5}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":6,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"DBImpl","repo":"leveldb","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":7,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"Code","repo":"leveldb","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":8,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"Options","repo":"leveldb","branch":"master","kind":"struct","limit":3}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":9,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"NonExistentSymbolXYZ123","repo":"leveldb","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":10,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"Version","repo":"leveldb","branch":"master","kind":"invalid_kind"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引；向量模型已加载 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":11,"method":"tools/call","params":{"name":"codeloom_semantic_search","arguments":{"query":"compaction and version management","repo":"leveldb","branch":"master","limit":5}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
| **预期结果** | JSON 响应，`count` > 0，结果包含 `name`/`kind`/`file`/`line`/`score`/`type`/`parent_class`（若方法）/`signature` 等字段 |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":12,"method":"tools/call","params":{"name":"codeloom_inspect","arguments":{"name":"Compaction","repo":"leveldb","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":13,"method":"tools/call","params":{"name":"codeloom_inspect","arguments":{"name":"DBImpl::Put","repo":"leveldb","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":14,"method":"tools/call","params":{"name":"codeloom_inspect","arguments":{"name":"Options","repo":"leveldb","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":15,"method":"tools/call","params":{"name":"codeloom_get_call_graph","arguments":{"name":"DBImpl::Put","repo":"leveldb","branch":"master","direction":"callers"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":16,"method":"tools/call","params":{"name":"codeloom_get_call_graph","arguments":{"name":"DBImpl::BackgroundCompaction","repo":"leveldb","branch":"master","direction":"callees","max_depth":2}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":17,"method":"tools/call","params":{"name":"codeloom_path_analysis","arguments":{"source":"DBImpl","target":"Options","repo":"leveldb","branch":"master","mode":"shortest"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":18,"method":"tools/call","params":{"name":"codeloom_path_analysis","arguments":{"source":"DBImpl","target":"Options","repo":"leveldb","branch":"master","mode":"all","edge_filter":["uses_type","contains"]}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":19,"method":"tools/call","params":{"name":"codeloom_impact_analysis","arguments":{"symbol":"Version","repo":"leveldb","branch":"master","direction":"forward","radius":1}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":20,"method":"tools/call","params":{"name":"codeloom_impact_analysis","arguments":{"symbol":"Version","repo":"leveldb","branch":"master","direction":"reverse","radius":2,"edge_filter":["param_type","return_type","uses_type"]}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":21,"method":"tools/call","params":{"name":"codeloom_neighbor_graph","arguments":{"symbol":"Version","repo":"leveldb","branch":"master","direction":"both"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
| **预期结果** | JSON 响应，`depth`=1（默认），`direction`=`"both"`，`symbol`=`"Version"`；`backward` 部分包含 `param_type`/`return_type`/`uses_type` 等反向引用；`forward` 部分包含 `via_member:param_type`/`via_member:return_type`/`via_member:uses_type`（符号作为成员的角色分类） |
| **验证方法** | 解析 JSON：验证 `forward.via_member:param_type` 包含 `"ReadOptions"`、`"std::string"` 等；验证 `forward.via_member:return_type` 包含 `"Status"`、`"Version"`；验证 `backward.param_type` 存在且非空 |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":22,"method":"tools/call","params":{"name":"codeloom_inheritance_tree","arguments":{"symbol":"DBImpl","repo":"leveldb","branch":"master","direction":"down","max_depth":3}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":23,"method":"tools/call","params":{"name":"codeloom_inheritance_tree","arguments":{"symbol":"Slice","repo":"leveldb","branch":"master","direction":"up","max_depth":3}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":24,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"Version","repo":"leveldb"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":25,"method":"tools/call","params":{"name":"codeloom_get_call_graph","arguments":{"name":"DBImpl::Put"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":26,"method":"tools/call","params":{"name":"codeloom_list_symbols","arguments":{"pattern":"main","repo":"nonexistent_repo","branch":"master"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
| **前置条件** | leveldb@master 已索引 |
| **JSON-RPC 请求** | `echo '{"jsonrpc":"2.0","id":27,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"Version","repo":"leveldb","branch":"nonexistent_branch"}}}' \| /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null` |
...
```bash
echo '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"codeloom_search","arguments":{"query":"DBImpl","repo":"leveldb","branch":"master","kind":"class"}}}' | /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null
```
...
```bash
echo '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"codeloom_inspect","arguments":{"name":"DBImpl","repo":"leveldb","branch":"master"}}}' | /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null
```
...
```bash
echo '{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"codeloom_get_call_graph","arguments":{"name":"DBImpl::Put","repo":"leveldb","branch":"master","direction":"callers"}}}' | /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null
```
...
```bash
echo '{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"codeloom_neighbor_graph","arguments":{"symbol":"DBImpl::Put","repo":"leveldb","branch":"master","direction":"both"}}}' | /mnt/d/RagMcpHermes/codeloom/target/debug/codeloom mcp 2>/dev/null
```
